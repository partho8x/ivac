...
def otp_slot_time(web_id, name, phone, email, otp, slotid):
    print(web_id+" "+name+" "+phone+" "+email+" "+otp+" "+slotid)
...
def index():
        if request.method == 'POST':
            ...
            response_data = otp_slot_time(web_id, name, phone, email, otp, slotid)
